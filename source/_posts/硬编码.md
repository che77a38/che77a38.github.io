...
![image-20210517110614296](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210517110614296.png)
...
![image-20210517121504731](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210517121504731.png)
...
![image-20210517124255812](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210517124255812.png)

![image-20210517122807231](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210517122807231.png)

查表方式：

![1502566-20181215195735075-1632848315](https://cdn.jsdelivr.net/gh/che77a38/blogImage/1502566-20181215195735075-1632848315.png)
...
![image-20210601180927470](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601180927470.png)

![image-20210601180946471](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601180946471.png)

1735页

![image-20210601181145342](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601181145342.png)
...
![image-20210601161252391](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601161252391.png)

假如上图中框选的部分为我们要跳过来77DE01E8执行的代码段，这是没使用花指令的情况下。

我们把77DE01E7的90改成B0

![image-20210601161559344](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601161559344.png)
...
![image-20210601180602207](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601180602207.png)

Jb：J表示间接寻址，即操作数是相对偏移；b表示操作数一个字节

下面的暂时不讲（没进0环之前下面指令基本用不到）

![image-20210601181544726](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210601181544726.png)
...
![image-20210603151613245](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603151613245.png)

ModR/M的目的就是告诉我们G和E到底是谁

这8个位究竟是如何工作的，Inter操作手册给出了一张表

![1502566-20181215195902895-1924133618](https://cdn.jsdelivr.net/gh/che77a38/blogImage/1502566-20181215195902895-1924133618.png)

![image-20210603162026207](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603162026207.png)

![image-20210603162045657](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603162045657.png)
...
![image-20210603163024666](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603163024666.png)

举例说明0x80 0x65 0x08 0xFF查表

![image-20210603164816516](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603164816516.png)

DIS8表示8位偏移

![image-20210603165041786](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603165041786.png)

1A可以查表看意思：![image-20210603165406263](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603165406263.png)
...
![image-20210603165308505](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603165308505.png)
...
3. 通过ModR/M的3,4,5位：![image-20210603171014362](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603171014362.png)
...
![image-20210603172025574](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603172025574.png)

Opcode决定了后面是否有ModR/M，ModR/M决定了后面是否存在SIB，Displacement和immediate

![image-20210603172713610](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603172713610.png)

查ModR/M表的时候如果ModR/M1,2,6,7,8位查到上图红线[--]这种形式，标明ModR/M后面需要再跟一个字节，就是SIB来确定[--]里面的信息

![image-20210603173312603](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603173312603.png)

sib用到的表

![image-20210603173524173](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603173524173.png)
...
![image-20210603173832029](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603173832029.png)

01的Scale部分决定了拿个SS

![image-20210603174113527](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210603174113527.png)
