...
1. PE文件的特征（PE指纹）
   ...
   ![image-20210604121004126](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604121004126.png)

2. 不要仅仅通过文件名的后缀名来认定PE文件（因为后缀名是可以改的）

PE文件结构

![image-20210604134303017](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604134303017.png)
...
<img src="https://gitee.com/ZEROKO14/blog-img/raw/master/img/pe%E7%BB%93%E6%9E%84%E5%9B%BE.JPG" alt="pe结构图"  />

详细的结构体信息参考**pe结构.pdf**

PE在文件中结构参考

![image-20211127210012444](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20211127210012444.png)
...
![image-20210604141102723](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604141102723.png)
...
![image-20210604180109514](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604180109514.png)
...
![image-20210604210332119](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604210332119.png)
...
![image-20210604220050538](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604220050538.png)

*比如Characteristics中二进制1100 0000 0000 0000 0000 0000 0100 0000*

*表示的是节中包含已初始化数据，映射到内存后的页面包含可读可写属性。*

*由此可知这个节存的都是可读可写的全局变量(参考C语言入门部分内存布局**全局初始化数据区/静态数据区**)*
...
![image-20210604162826452](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604162826452.png)
...
![image-20210604163038120](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210604163038120.png)

![tempsnip](https://gitee.com/ZEROKO14/blog-img/raw/master/img/tempsnip.png)
...
![image-20210605145444540](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210605145444540.png)
...
![image-20210606121703626](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210606121703626.png)

新增节前：

![image-20210606115603452](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210606115603452.png)

新增节后：（.tttt为新增节的名称）

![image-20210606115642621](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210606115642621.png)
...
![image-20210406133806124](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210406133806124.png)
...
![image-20210607121906024](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607121906024.png)

### 函数名称表

![image-20210607122444890](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607122444890.png)
...
![image-20210607123144789](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607123144789.png)
...
![image-20210607132251965](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607132251965.png)

![image-20210708142928288](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210708142928288.png)
...
![image-20210607134402552](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607134402552.png)
...
![image-20210607140823333](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607140823333.png)

这个call的地址指向的内容是

![image-20210607141338756](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607141338756.png)
...
![20131007225555312](https://gitee.com/ZEROKO14/blog-img/raw/master/img/20131007225555312.jpg)

加载到内存后：

![20131007225859203](https://gitee.com/ZEROKO14/blog-img/raw/master/img/20131007225859203.jpg)

此时FirstThunk指向的不再是OriginalFirstThunk指向的结构

![image-20210607141808212](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607141808212.png)
...
![image-20210607151337405](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607151337405.png)
...
![image-20210607163327446](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607163327446.png)
...
![image-20210607164617022](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210607164617022.png)
...
![image-20211125115210958](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20211125115210958.png)
