...
![image-20200603164550546](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200603164550546.png)
...
![image-20200603164753061](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200603164753061.png)

继续进该call追，发现问题所在

![image-20200603170343620](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200603170343620.png)

ebp-4表示局部变量，局部变量在本层call中未改变，说明ebp-4来源于内部call中，经单步观察是来源于0066588b地址这个call中。内部call想改变外部call只可能是通过指针的方式传进去内部call改变

简单分析：

![image-20200603172032838](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200603172032838.png)

call内继续往上追：

![image-20200603172228215](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200603172228215.png)

追到一个循环结构，应该是某种数据结构。然后发现该循环结构只是决定于ebx套几层循环，事实上是ebx不做任何改变也能dd出血地址，因此直接略过该循环结构。

![image-20200604134014792](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200604134014792.png)
...
![image-20200609152105778](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200609152105778.png)
...
![image-20200609161113905](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200609161113905.png)
...
![image-20200606165410225](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200606165410225.png)
...
![image-20200609164617116](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200609164617116.png)
$$
...
![image-20200609171928839](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200609171928839.png)
...
![image-20200610115440267](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200610115440267.png)
...
![image-20200610140531244](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200610140531244.png)
...
![image-20200610144038590](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200610144038590.png)

不知道为什么区域恶霸显示是这样的？可能是%s 放前面的原因，放在后面就没问题了。

将id也打印出来，效果如下:

![image-20200619203613803](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619203613803.png)
...
![image-20200612142353797](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200612142353797.png)

此处又发现了数组结构，并且通过执行断点，发现数组结构中的下标ecx是分段式连续的，从0-1d，0-13。从1d进入下一段的时候eax发生变化，eax有两种情况。结合游戏：

![image-20200612142702850](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200612142702850.png)
...
![image-20200612162228639](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200612162228639.png)

追到此处发现：eax来源于图中的call，该call的esi参数断下后传入的依次是0-5，结合游戏有5个妆效背包的位置和原有的默认初始提供的30格空间，相当于6个背包，正好是0-5表示序号。即可确定该call是背包对象的来源。进入：

![image-20200612162542084](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200612162542084.png)

call中除了调了一个call外啥也没做，并且该call的eax参数依然是装背包的位置的格子序号，显然要继续进call：

![image-20200612163010995](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200612163010995.png)
...
![image-20200616121616564](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200616121616564.png)

然后点击GBK到BIG5 ，变为如下图：

![image-20200616121652661](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200616121652661.png)
...
![image-20200616123037380](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200616123037380.png)
...
![image-20200616124233780](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200616124233780.png)

因为是硬件断，所以实际的物品名称为[esi+ecx*4-8],此处断下时ecx==2，追esi。

因为是字符串，尝试跳出最底层堆栈。

![image-20200616125251278](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200616125251278.png)

找到此处为该call第三个参数，跳过去。

继续分析：找到字符串处理分叉：

![image-20200617140130766](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200617140130766.png)

继续向上追，追eax追到eax来源于这个call，发现这个call的参数是物品id，可以直接调用这个call获取eax返回值，该call应该是通过物品id取物品对象的call。

![image-20200617123047040](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200617123047040.png)

该call类似于通过id汉化物品名字

![image-20200617130410963](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200617130410963.png)
...
![image-20200617173409222](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200617173409222.png)
...
![image-20200618105542581](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618105542581.png)
...
![image-20200618124459759](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618124459759.png)
...
![image-20200618121851520](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618121851520.png)

两个技能时候：

![image-20200618121807662](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618121807662.png)

放三个技能时候：

![image-20200618121940617](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618121940617.png)
...
![image-20200618150730099](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618150730099.png)

转成BIG5：

![image-20200618150751691](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618150751691.png)
...
![image-20200618151416145](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618151416145.png)
...
![image-20200619200502840](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619200502840.png)
...
![image-20200618174812697](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200618174812697.png)
...
![image-20200619114555309](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619114555309.png)
...
![image-20200619121515351](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619121515351.png)
...
![image-20200619143158127](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619143158127.png)
...
![image-20200619190705774](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619190705774.png)
...
![image-20200619191343990](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619191343990.png)

逐个用od来dd地址下访问断，0的表示查看和释放技能都不断的，找到了能断下的，并且是一个二叉树结构。

![image-20200619191918680](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619191918680.png)
...
![image-20200619193746843](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619193746843.png)
...
![image-20200619200020569](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200619200020569.png)
...
![image-20200527130037272](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527130037272.png)

[该call第二个参数+4]为包地址

![image-20200527131220102](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527131220102.png)

此处edx+esi由于多次下断edx均为0，直接视edx为0，继续追esi。

![image-20200527132100884](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527132100884.png)

任何主动行为都是edi==0D64200C一直不变，某个心跳包会出现edi==2986f00c

edi+2888追到此

![image-20200527135319069](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527135319069.png)
...
![image-20200527140538839](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527140538839.png)
...
![image-20200527142213922](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527142213922.png)
...
![image-20200527154018241](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527154018241.png)
...
![image-20200527170418581](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200527170418581.png)
...
![image-20200528140218927](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200528140218927.png)
...
![image-20200530123037751](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200530123037751.png)

收包内容地址固定，在比较远的位置下硬件访问断来断下我们的超长文本收包，然后到游戏中喊话一大段1111......（如图位置下断避开其他包的干扰）（喊话既发包，也收包）。此处访问断断下的位置要么是解密call，要么是位置迁移（此处下软件断会崩溃）

![image-20200530123208857](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200530123208857.png)
...
![image-20200530124227755](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200530124227755.png)

其中出现明文，可知此处是正在解密中的位置，ctrl+f9返回上一层即解密call

![image-20200530124751654](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200530124751654.png)

由此发现，此处找到的解密call和上面找到的加密call为同一个call，说明该加密为对称性加密，此call为加解密call。

分析:

![image-20200530131542117](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200530131542117.png)
...
![image-20200617150015519](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200617150015519.png)
...
![image-20200623115813014](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200623115813014.png)

内存布局和下写入断断下与否分析：

![image-20200623125915308](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200623125915308.png)
...
![image-20200623134251855](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200623134251855.png)
...
![image-20200628115800117](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200628115800117.png)
...
![image-20200628120134118](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200628120134118.png)
...
![image-20200629131032241](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629131032241.png)
...
![image-20200629151827052](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629151827052.png)
...
![image-20200629171419862](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629171419862.png)
...
![image-20200629180635247](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629180635247.png)
...
![image-20200629181014255](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629181014255.png)

![image-20200629181034665](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200629181034665.png)
...
![image-20200630180024957](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200630180024957.png)
...
![image-20200630183041901](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200630183041901.png)
...
![image-20200630190413663](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200630190413663.png)
...
![image-20200701142941429](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200701142941429.png)

注意点：

![image-20200701145906136](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200701145906136.png)
...
![image-20200701151102938](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200701151102938.png)
...
![image-20200701154135148](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200701154135148.png)
...
![image-20200701164710276](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200701164710276.png)
...
![image-20200703123124781](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703123124781.png)

![image-20200703123901382](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703123901382.png)
...
![image-20200703133334276](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703133334276.png)
...
![image-20200703134009568](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134009568.png)

在上图中双击想要定位的基地址：

出现一个箭头如下：

![image-20200703134243403](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134243403.png)

然后在这周围选中一片区域，点设置特征，如下：

![image-20200703134336551](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134336551.png)

然后在自己存子程序的txt文件右键点设置，如下：

![image-20200703134417594](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134417594.png)

定位F3C570的例子填写如下

![image-20200703134645865](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134645865.png)

然后在自己存子程序的txt文件右键点开始定位：输出结果：

![image-20200703134718333](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134718333.png)

只显示一个代表定位成功！

如果显示很多条，效果如下

![image-20200703134929816](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703134929816.png)
...
![image-20200703135805836](https://raw.githubusercontent.com/che77a38/blogImage/main/image-20200703135805836.png)
