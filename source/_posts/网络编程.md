...
函数参数:
	...
	`ppDerPrintString`: 输出参数, ITCAST_ANYBUF指针的指针, 表示编码成链表格式之后的数据,用于**构造链表**
返回值:
	成功或者失败	
...
<img src="https://raw.githubusercontent.com/che77a38/blogImage2/main/202302201320179.jpeg" alt="ASN.1 编解码- 类图jpg_Page1"  />
