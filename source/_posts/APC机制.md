...
![image-20211013171657971](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211013171657971.png)

![image-20211023213229559](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211023213229559.png)

![image-20211023213307816](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211023213307816.png)
...
![image-20211028152615008](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211028152615008.png)
...
![image-20211018180147858](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211018180147858.png)

### 用户APC挂入流程

![image-20211012154033183](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211012154033183.png)
...
![image-20211019150353138](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211019150353138.png)

#### KeInsertQueueApc函数

![image-20211029143018774](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211029143018774.png)
...
![image-20211101140140226](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211101140140226.png)

该函数返回值为1表示APC已插入，但**如果UserApcPending未置1，则该用户APC未必有机会执行**

插入的上半部分

![image-20211101164401536](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211101164401536.png)

插入的下半部分

<img src="https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211101164523600.png" alt="image-20211101164523600"  />
...
![image-20211026232558356](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211026232558356.png)
...
<img src="https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211015132902898.png" alt="image-20211015132902898"  />
...
![image-20211023221626174](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211023221626174.png)

![deliver](https://cdn.jsdelivr.net/gh/che77a38/blogImage/deliver.png)

上图是从用户模式调用Native API才走KiServiceExit2

**总览流程图**

![image-20211118112937375](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211118112937375.png)

![20201202171056458](https://cdn.jsdelivr.net/gh/che77a38/blogImage/20201202171056458.png)
...
![image-20211016154954475](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211016154954475.png)![image-20211016155050235](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211016155050235.png)
