...
[windows oracle数据库安装参考](https://blog.csdn.net/zouxun660/article/details/126232529)
...
其中`Community Server` 可以直接从mysql 的官网下载。但E`nterprice Edition`只能从`Oracle edelivery`上下载，而`Edelivery`有时会屏蔽中国IP。
...
`mysql -u用户名 -p密码`进入mysql命令行    e.g.`mysql -uroot -p12345`
...
![image-20221031112333528](https://raw.githubusercontent.com/che77a38/blogImage2/main/202210311123690.png)
...
![image-20221031142000017](https://raw.githubusercontent.com/che77a38/blogImage2/main/202210311420970.png)
...
![image-20221031173810379](https://raw.githubusercontent.com/che77a38/blogImage2/main/202210311738498.png)
...
```c
MYSQL *conn = mysql_real_connect(mysql,"localhost","root","@Che77a38","myTest",0,NULL,0);
if(conn == NULL)
{
...
![image-20221114152116545](https://raw.githubusercontent.com/che77a38/blogImage2/main/202211141522005.png)
...
![image-20221122164501715](https://raw.githubusercontent.com/che77a38/blogImage2/main/202211221646758.png)
...
typedef struct MYSQL_BIND {
  unsigned long *length; /*问号为字符串类型该项必须赋值,表示字符串长度 output length pointer */
  ...
  unsigned long buffer_length;//缓冲区长度,字符串要提供
...
![image-20221122172303182](https://raw.githubusercontent.com/che77a38/blogImage2/main/202211221724158.png)
...
![image-20221224153050288](https://raw.githubusercontent.com/che77a38/blogImage2/main/202212241530981.png)
...
OpenSSL既可以在windows平台下使用,也可以在linux平台下使用,是跨平台的一套加密库
...
![image-20221231152119110](https://raw.githubusercontent.com/che77a38/blogImage2/main/202212311521546.png)

#### win下使用openssl

设置项目属性,将openssl的头文件目录和库目录添加到当前项目中

![image-20221231152435770](https://raw.githubusercontent.com/che77a38/blogImage2/main/202212311525657.png)
...
![image-20221231154325461](https://raw.githubusercontent.com/che77a38/blogImage2/main/202212311543694.png)

![image-20221231154349203](https://raw.githubusercontent.com/che77a38/blogImage2/main/202212311543177.png)
...
[OpenSSL linux版安装路径](https://github.com/openssl/openssl/tree/OpenSSL_1_1_1-stable)
