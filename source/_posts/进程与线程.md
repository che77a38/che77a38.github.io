...
![image-20210909142442752](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909142442752.png)

![image-20210909142343552](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909142343552.png)
...
![image-20210906162843550](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210906162843550.png)
...
OD附加前：![image-20210909171530578](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909171530578.png)

OD附加后：![image-20210909171108678](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909171108678.png)

**2、用OD附加记事本，下断点，然后在windbg中清空EPROCESS中的DebugPort中的值，然后单步调试，观察结果.**

修改前：![image-20210909165418505](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909165418505.png)

修改后：![image-20210909165445414](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909165445414.png)

单步调试触发：

![image-20210909165516800](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909165516800.png)
...
断链前：![image-20210909173755007](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909173755007.png)

锻炼后：![image-20210909173913107](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909173913107.png)

但是这里还是能看到：

![image-20210909173241836](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210909173241836.png)
...
![image-20210907153725611](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210907153725611.png)
...
![image-20210912105201611](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210912105201611.png)
...
![image-20210912105028347](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210912105028347.png)

线程对象头：

![image-20210912105300055](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210912105300055.png)
...
![image-20210913143736703](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913143736703.png)

全局变量**KiReadySummary**，32位，如果哪个存在就绪链表，其该位被置1。其从低位到高位就绪链表优先级依次升高，因此需要找从左边数第一个为1的位数，该位作为位数从KiDispatchReadListHead数组中寻找。

![1827556-20200422144013785-765135328](https://gitee.com/ZEROKO14/blog-img/raw/master/img/1827556-20200422144013785-765135328.png)
...
![image-20210910191936188](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210910191936188.png)
...
7. 空闲线程的\_KTHREAD,当KiFindReadyThread找KPCR中的nextThread为空，并且也找不到就绪链表中有线程的时候，就把线程交换给空闲线程。
   ...
   ![image-20210917174204289](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917174204289.png)
   ...
   ![image-20210917175257328](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917175257328.png)

   windbg当前断下的就是IdleThread线程。

   ![image-20210917174430574](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917174430574.png)![image-20210917174644671](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917174644671.png)

   ![image-20210917174728430](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917174728430.png)
...
![image-20210911111900026](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210911111900026.png)
...
![image-20210911143508984](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210911143508984.png)
...
![image-20210912143605531](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210912143605531.png)
...
![image-20210917180706498](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210917180706498.png)

#### 内核堆栈的结构

![image-20210913123031866](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913123031866.png)![image-20210913123046400](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913123046400.png)

##### _Trap_Frame结构

![image-20210913123224608](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913123224608.png)
...
<img src="https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913122330491.png" alt="image-20210913122330491" style="zoom: 50%;" /><img src="https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913122350154.png" alt="image-20210913122350154" style="zoom:50%;" /><img src="https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913122429778.png" alt="image-20210913122429778" style="zoom: 50%;" />
...
![image-20210912205808625](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210912205808625.png)
...
![image-20210913113450583](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913113450583.png)
...
![image-20210913144629239](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913144629239.png)
...
![image-20210913170303489](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913170303489.png)
...
![image-20210913175616484](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913175616484.png)
...
![image-20210913180101685](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210913180101685.png)
...
![image-20210915203346309](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210915203346309.png)
...
![image-20210915222903975](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210915222903975.png)
...
![image-20210915232306154](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210915232306154.png)
...
![image-20210916200240912](https://gitee.com/ZEROKO14/blog-img/raw/master/img/image-20210916200240912.png)
