...
![dump](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205171721503.jpeg)
...
![image-20210825212547927](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210825212547927.png)
...
![image-20210828154334924](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210828154334924.png)
...
![image-20210830211435935](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210830211435935.png)
...
![regsyscallback](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205291945467.jpeg)
...
![v2-e07e93bb06ba604bbe332d3bfbc0183a_1440w](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205041101739.jpeg)
...
![v2-fe188ac7d8bd77ba391df598072daa18_1440w](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205041103204.jpeg)
...
![v2-29347fc67c90d940d2ba3e58702b5035_1440w](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205041105434.jpeg)
...
![foreach](https://cdn.jsdelivr.net/gh/che77a38/blogImage2/202205292047586.jpeg)

tp刚开始可以读取,但是过了一会儿又不能访问了,很可能tp有遍历[[句柄表]],找谁打开了自己的句柄,就释放掉.

## 句柄表遍历相关

[x86相关句柄表遍历跳出到句柄表文章](https://zeroko14.gitee.io/blog/2022/05/05/%E5%8F%A5%E6%9F%84%E8%A1%A8/)
...
[NtQuerySystemInformation遍历句柄微软API讲解跳转](https://docs.microsoft.com/en-us/windows/win32/api/winternl/nf-winternl-ntquerysysteminformation)
...
__kernel_entry NTSTATUS NtQuerySystemInformation(
  [in]            SYSTEM_INFORMATION_CLASS SystemInformationClass,//SYSTEM_INFORMATION_CLASS中枚举的值之一，指示要检索的系统信息的类型
  [in, out]       PVOID                    SystemInformation,//指向接收请求信息的缓冲区的指针。 此信息的大小和结构因 SystemInformationClass 参数的值而异：
  [in]            ULONG                    SystemInformationLength,//SystemInformation 参数指向的缓冲区的大小（以字节为单位）
  [out, optional] PULONG                   ReturnLength//指向函数写入所请求信息的实际大小的位置的可选指针。 如果该大小小于或等于SystemInformationLength 参数，函数将信息复制到 SystemInformation 缓冲区中;否则，它会返回 NTSTATUS 错误代码，并在 ReturnLength 中返回接收请求的信息所需的缓冲区大小。
);
//返回值:返回 NTSTATUS 成功或错误代码。
```

实现句柄遍历代码:

下面需要用到的数据结构包含在[该头文件中(点击跳转)](#R3用到的内核相关结构体大整合)
...
#define STATUS_NOT_IMPLEMENTED ((NTSTATUS)0xC0000002L)
	...
	typedef enum _SYSTEM_INFORMATION_CLASS
	{
		...
		//100?
		SystemPageMemoryInformation = 123,//�Զ���
