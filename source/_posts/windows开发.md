...
![image-20210615121702693](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615121702693.png)
...
![image-20210615134439052](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615134439052.png)
...
![image-20210615144439614](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615144439614.png)
...
![image-20210615144902520](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615144902520.png)
...
![image-20210615145614061](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615145614061.png)
...
![image-20210615150920853](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615150920853.png)
...
![image-20210615155616437](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615155616437.png)

父进程的句柄表中绿色表格部分表示**该句柄是否可以被子进程继承**。

**创建子进程的bInheritHandles参数如果指定了true，表示该子进程继承父进程的句柄表，但只能继承绿色表格部分为1的句柄**。

![image-20210615162232666](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615162232666.png)
...
![image-20210615163527181](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210615163527181.png)
...
![image-20210619181855365](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210619181855365.png)

产生的问题如下：

![image-20210619182205646](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210619182205646.png)
...
![image-20210619190656121](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210619190656121.png)

真正的原理如何实现的参考**内核笔记**

# 互斥体

![image-20210619190048156](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210619190048156.png)

内核级临界资源怎么办？

要既可以A进程中的X线程可以访问，又要进程b中的y线程可以访问，同时还必须线程安全

![image-20210619190359223](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210619190359223.png)
...
![image-20210623173443224](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210623173443224.png)
...
![image-20210623175414083](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210623175414083.png)
...
![image-20210623183240740](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210623183240740.png)

高2G是内核空间，多进程公用，里面有很多系统模块。

其中和窗口最相关的主要是两个系统模块：

![image-20210623183337829](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210623183337829.png)
...
![image-20210627131449985](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627131449985.png)

操作系统先捕获到我们的键盘鼠标操作，然后**根据每个窗口在内核的结构体中的信息，找到对应窗口的对应负责消息队列的线程，将消息放进他的消息队列**。

![image-20210627132533158](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627132533158.png)
...
![image-20210627133328265](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627133328265.png)
...
![image-20210627141039758](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627141039758.png)
...
![image-20210627151302111](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627151302111.png)

无TranslateMessage的情况

![image-20210627151210561](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627151210561.png)
...
![image-20210627144328602](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627144328602.png)
...
![image-20210627171511300](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627171511300.png)
...
![5396392-230b8f4ea39a4f00](https://cdn.jsdelivr.net/gh/che77a38/blogImage/5396392-230b8f4ea39a4f00.webp)
...
![image-20210627184154084](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627184154084.png)

物理内存不够用，可以把硬盘当成内存，操作如下：

![image-20210627184851391](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627184851391.png)

自定义大小中的初始大小可以修改硬盘当物理内存使用的大小。该大小可以在c盘直观地看到一个叫pagefile.sys的文件，占用就和你设置的值一样。

对于程序员来说**感知不到物理内存的存在**是因为操作系统做了下面这些事：

![image-20210627185746450](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210627185746450.png)
...
![image-20210628152849905](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210628152849905.png)

下断点查看那块内存：

![image-20210628153031108](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210628153031108.png)
...
![image-20210630122311355](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210630122311355.png)

**磁盘配额**：让别的用户只能固定使用某个磁盘多少空间

![image-20210630122444855](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210630122444855.png)

文件系统：

![image-20210628154143292](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210628154143292.png)
...
![image-20210703130407329](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703130407329.png)
...
![image-20210703132545845](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703132545845.png)
...
![image-20210703161630006](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703161630006.png)
...
![image-20210703161739985](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703161739985.png)
...
![image-20210703163120600](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703163120600.png)
...
![image-20210703170047278](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703170047278.png)
...
![image-20210703170103293](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703170103293.png)

# 内存映射文件实现读写文件

内存映射文件：把一个硬盘里的文件直接映射到物理页上，直接再把物理页映射到进程的虚拟内存里（如图）

![image-20210703185707851](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703185707851.png)![image-20210703222153407](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703222153407.png)
...
![image-20210703221045789](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703221045789.png)

原本的文件：

![image-20210703193415048](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703193415048.png)

修改后的文件：

![image-20210703220919906](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703220919906.png)
...
![image-20210703222600004](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703222600004.png)
...
![image-20210703223924648](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703223924648.png)![image-20210703224651453](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210703224651453.png)
...
![image-20210706131700275](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210706131700275.png)
...
![image-20210707145837215](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707145837215.png)

![image-20210707150201266](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707150201266.png)

![image-20210707150256851](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707150256851.png)

![image-20210707153018376](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707153018376.png)

![image-20210707153029369](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707153029369.png)

[结构详解]: https://www.freesion.com/article/19771019476/

上面的图实际上都不是那么准确，下面这张图才是真正的结构。

![image-20210707155954691](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707155954691.png)
...
![image-20210706162954067](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210706162954067.png)
...
1. 不能有全局变量
2. 不能使用常量字符串
3. 不能使用[[系统调用]]（因为系统调用是间接调用，call的地址要等到exe启动的时候由操作系统根据导入表填写的）
...
2. 用局部数组写字符串
   ...
   ![image-20210607170623362](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210607170623362.png)

3. 因为调用其他PE的函数都是采用间接CALL的调用方式，实际上是由编译器填写的。系统调用都是在其他DLL中的，所以ShellCode中不能使用系统调用。

   ![image-20210607172332382](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210607172332382.png)
...
![image-20210707174332826](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707174332826.png)

修改后：

![image-20210707174410932](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707174410932.png)
...
![image-20210707184145923](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210707184145923.png)
...
![image-20210708190212173](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210708190212173.png)![image-20210708190233787](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210708190233787.png)![image-20210708190305081](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210708190305081.png)
...
![image-20210709000121629](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210709000121629.png)

发现此处不需要修正函数地址，add函数名称直接是add的真实地址。目测是VS2015有自动修正。

上面代码的VirtualProtect中PAGE_EXECUTE_READWRITE改为PAGE_READWRITE会报错：

![image-20210709002047122](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210709002047122.png)
...
![image-20210710150602775](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210710150602775.png)

HOOK后：

![image-20210710150629920](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210710150629920.png)
...
![image-20210709163413382](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210709163413382.png)

结果：

![image-20210709162621067](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210709162621067.png)
...
![image-20210714143816162](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210714143816162.png)
...
![image-20210710163925510](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210710163925510.png)
...
![image-20210715194421171](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210715194421171.png)
...
![image-20211124154438711](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211124154438711.png)![image-20211124154455104](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20211124154455104.png)
...
![image-20210608224348679](https://cdn.jsdelivr.net/gh/che77a38/blogImage/image-20210608224348679.png)
