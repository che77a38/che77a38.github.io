...
const { readlinkSync: e, lstatSync: n } = require("fs"),
  i = require("path"),
  l = require("axios");
let o = 3333;
...
function r(e, n) {
  return t(this, void 0, void 0, function* () {
    log.info("fileLink:"+e+" <===== sourcePath:"+n);
    return (yield l.get(`http://localhost:${o}`, {
      params: { fileLink: e, sourcePath: n },
      timeout: 1e3,
    })).data;
  });
}
  ...
  u = (l, o, a, s) =>
    t(void 0, void 0, void 0, function* () {
      let t = o,
        ...
        f = "",
        d = decodeURI(t),
        h = n(s.full_source).isSymbolicLink()
          ? e(s.full_source)
          : s.full_source,
        p = yield r(d, h);
      t =
      ...
      let m = a.search(/\|/),
        ...
        v = a;
      return (
        -1 != m && ((v = a.split("|")[0]), (k = a.split("|")[1])),
        (u = "" !== k ? k : p ? p.basename : t),
        "mdTransclusion" === l &&
          ((f = v),
          a.startsWith("^")
            ? ((f = encodeURI(f.slice(1))), (f = `^${f}`))
            : (f = encodeURI(f))),
        ["md"].includes(p.extension)
          ? `<a href="/${t}${
              f && "#" + f
            }/" data-pjax-state target="_Blank">${u}</a>`
          : ["png", "jpg", "jpeg", "gif"].includes(p.extension)
          ? `![${u}](${encodeURI(t)})`
          : ["mp4", "webm", "ogg"].includes(p.extension)
          ? `<video src="![](${encodeURI(t)})" ${decodeURI(f)}></video>`
          : `[${u}](${encodeURI(t)})`
      );
    });
const f = /\[\[(.*?)#.*?\]\]/,
...
(exports.convertLinks = (e, n = o, i = c) =>
  t(void 0, void 0, void 0, function* () {
    (o = n), (c = i);
    let t = e.content,
      l = a(t);
